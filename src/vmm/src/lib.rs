...
// Self-contained module — does NOT use the upstream Vmm infrastructure.
#[cfg(target_os = "windows")]
pub mod windows;

// ── Unix (Linux + macOS) upstream VMM infrastructure ─────────────────────────
// Everything below is the original Firecracker/libkrun VMM code that depends
// on KVM (Linux), Hypervisor.framework (macOS), and POSIX APIs.
#[cfg(unix)]
pub mod builder;
#[cfg(unix)]
